...
\usepackage[margin=18mm,bindingoffset=5mm]{geometry}
...
\begin{document}
	...
	\begin{itemize}
		...
		\subitem 2016 : Membre de l'équipe de Sorbonne Université
		\subitem 2018--2020 : Encadrante de l'équipe de Sorbonne Université
		\subitem 2021--2022 : Membre de l'équipe d'organisation du tournoi \\
	...
	\begin{figure}[h]
		...
		\begin{minipage}[c]{0.85\linewidth}
			\centering
			\includegraphics[width=0.45\linewidth]{./Illustrations/SHE_electrons.eps}
	...
	\begin{figure}[h]
		...
		\begin{minipage}[c]{0.85\linewidth}
			\centering
			\includegraphics[width=0.78\linewidth]{./Illustrations/figure_scatt.eps} \\
			(b) \hspace{0.1cm} \includegraphics[width=0.75\linewidth]{./Illustrations/Photo_diff_desordre_3D}
